...
/**
 * Servlet implementation class UpdateDeptServlet2
 */
@WebServlet("/Dept/Update2")
public class UpdateDeptServlet2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("PostUD");
		String deptNo = request.getParameter("deptNo");
		String dName = request.getParameter("dName");
		String dLoc = request.getParameter("dLoc");
		DeptDaoImpl dd = new DeptDaoImpl();
		dd.updateDept(new Dept(Integer.parseInt(deptNo), dName, dLoc));
